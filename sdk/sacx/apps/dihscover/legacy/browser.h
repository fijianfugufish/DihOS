...
#define DIHSCOVER_IMAGE_CAP 24u
...
enum browser_tag {
    ...
    B_TAG_SELECT, B_TAG_H4, B_TAG_H5, B_TAG_H6, B_TAG_CODE, B_TAG_BLOCKQUOTE,
    B_TAG_FIGURE, B_TAG_FIGCAPTION, B_TAG_SMALL
};
...
typedef struct browser_style {
    ...
    int16_t inset_top, inset_right, inset_bottom, inset_left;
    int16_t z_index;
...
int browser_document_set_script_source(browser_document *doc, uint32_t node_index, const char *source, uint32_t size);
